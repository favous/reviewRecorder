...
//        inputLabel.setBackground(new Color(Display.getCurrent(), 255, 255, 255));
...
//
//        final Table table = new Table(rootComposite, SWT.MULTI | SWT.FULL_SELECTION | SWT.BORDER);
...
//            TableItemControls cons = new TableItemControls(name, type, value, editName, editType, editValue);
//            tablecontrols.put(items[i], cons);
//        }
//
//        Label outputLabel = new Label(rootComposite, SWT.NONE);
//        outputLabel.setText("Output Type:");
//        outputLabel.setBackground(new Color(Display.getCurrent(), 255, 255, 255));
...
//                    TableItem item = new TableItem(table, SWT.NONE);
//                    item.setText(new String[] { "郑六" + new Random().nextInt(15), "女", "568" });
//                }
//                // 如果单击删除按钮
